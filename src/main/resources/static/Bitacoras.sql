...
BEGIN
    IF INSERTING THEN
    B_ORDER_DETAIL_CREATE(:new.ID_DETAIL,:new.ID_PROVIDER_BY_PRODUCT,:new.QUATITY_IN,:new.PRICE_BY_PRODUCT,:new.TOTAL_ORDER,:new.ID_ORDER);
    ELSIF DELETING  THEN
    B_ORDER_DETAIL_DELETE(:old.ID_DETAIL,:old.ID_PROVIDER_BY_PRODUCT,:old.QUATITY_IN,:old.PRICE_BY_PRODUCT,:old.TOTAL_ORDER,:old.ID_ORDER);
    ELSIF UPDATING THEN
    B_ORDER_DETAIL_UPDATE(:old.ID_DETAIL,:old.ID_PROVIDER_BY_PRODUCT,:old.QUATITY_IN,:old.PRICE_BY_PRODUCT,:old.TOTAL_ORDER,:old.ID_ORDER);
    END IF;
END;
...
BEGIN
  INSERT INTO BITACORA_ORDER_DETAIL VALUES (USER,'INSERT',PID_DETAIL,PID_PROVIDER_BY_PRODUCT,PQUATITY_IN,PPRICE_BY_PRODUCT,PTOTAL_ORDER,PID_ORDER,SYSDATE);
END;
...
PID_ORDER IN BITACORA_ORDER_DETAIL.ID_ORDER%TYPE) AS
BEGIN
  INSERT INTO BITACORA_ORDER_DETAIL VALUES (USER,'DELETE',PID_DETAIL,PID_PROVIDER_BY_PRODUCT,PQUATITY_IN,PPRICE_BY_PRODUCT,PTOTAL_ORDER,PID_ORDER,SYSDATE);
END;
...
PID_ORDER IN BITACORA_ORDER_DETAIL.ID_ORDER%TYPE) AS
BEGIN
  INSERT INTO BITACORA_ORDER_DETAIL VALUES (USER,'UPDATING',PID_DETAIL,PID_PROVIDER_BY_PRODUCT,PQUATITY_IN,PPRICE_BY_PRODUCT,PTOTAL_ORDER,PID_ORDER,SYSDATE);
END;
